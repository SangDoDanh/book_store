...
export class CartService {
  ...
  payBook(book: Book, idCustomer: number): Observable<any> {
    return this.httpClien.put<any>(API_URL + `/cus/${idCustomer}`, book);
  }
}
